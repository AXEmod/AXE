...
[_text, _color, _sound, _delay, _position] spawn {
	...
	private _hint_color_bg		= (missionNamespace getVariable ["axe_hint_color_background", [0.000,0.000,0.000,0.5]]);
	private _hint_color_0		= (missionNamespace getVariable ["axe_hint_color_default", [0.000,0.824,0.000,1]]);
	private _hint_color_1		= (missionNamespace getVariable ["axe_hint_color_info", [0.824,0.824,0.000,1]]);
	private _hint_color_2		= (missionNamespace getVariable ["axe_hint_color_alert", [0.824,0.000,0.000,1]]);
	private _hint_queue_size	= (missionNamespace getVariable ["axe_hint_queue_size", 3]);
	private _hint_queue_alpha	= (missionNamespace getVariable ["axe_hint_queue_alpha", 0.4]);
