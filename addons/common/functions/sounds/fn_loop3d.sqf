 ...
 *	\axe_common\functions\sounds\fn_loop3d.sqf
 *	by Ojemineh
 *
 *	loop local sound at object position
 *
 *	Arguments:
 *	0: object		- <OBJECT>
 *	1: soundClass	- <STRING>
 ...
 *
 *	Example:
 *	[player, "BattlefieldFirefight1_3D", 300, 1000, 10] call AXE_fnc_loop3d;
 *
 */
...
if (_soundInUse) exitWith {
	...
	[_object, _soundClass, _hearDistance, _playDistance, _duration, _pitch, _isSpeech, _attach] call AXE_fnc_loop3d;
};
...
private _handler = [_object, _soundObject, _soundClass, _hearDistance, _playDistance, _duration, _pitch, _isSpeech] spawn {
	...
	[5, "loop3d '%1' on Object '%2'", [_soundClass, _soundObject], "common"] call AXE_fnc_diagLog;
	
	while {(Not isNull _soundObject) && (alive _object)} do {
