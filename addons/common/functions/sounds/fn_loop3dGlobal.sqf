 ...
 *	\axe_common\functions\sounds\fn_loop3dGlobal.sqf
 *	by Ojemineh
 *
 *	loop global sound at object position
 *
 *	Arguments:
 *	0: object       - <OBJECT>
 *	1: soundClass   - <STRING>
 ...
 *
 *	Example:
 *	[player, "BattlefieldFirefight1_3D", 300, 1000, 10] call AXE_fnc_loop3dGlobal;
 *
 */
...
[_object, _soundClass, _hearDistance, _playDistance, _duration, _pitch, _isSpeech, _attach] remoteExecCall ["AXE_fnc_loop3d", 0];
